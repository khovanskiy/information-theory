...
<div class='container'>
    ...
    <p class="lead">
        ...
        Пусть <span class="tex" data-value="B = L - n + 1">B = L - n + 1</span>.<br/>
    ...
    <p class="lead">
        Энтропия считается аналогично, но вероятность невстретившихся символов будет равна <span class="tex" data-value="1 / N ^ n">1 / N ^ n</span>
    </p>
